    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('declared_volume', models.FloatField(blank=True, null=True, verbose_name='Volume Declarado (m³)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dcf', models.CharField(max_length=50, validators=[django.core.validators.RegexValidator(message='Insira um valor válido, usando o formato 0000000000000/00-00.', regex='^\\d{13}/\\d{2}-\\d{2}$')], verbose_name='DCF')),
