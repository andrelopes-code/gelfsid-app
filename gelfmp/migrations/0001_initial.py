# Generated by Django 5.1.3 on 2024-12-14 02:50
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cep', models.CharField(help_text='Insira apenas os números.', max_length=10, validators=[django.core.validators.RegexValidator(message='Insira um CEP válido. Use o formato 00000000 ou 00000-000.', regex='^(\\d{8}|\\d{5}-\\d{3})$')], verbose_name='CEP')),
