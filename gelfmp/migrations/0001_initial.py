    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_type', models.CharField(choices=[('witness', 'Testemunha'), ('legal_representative', 'Representante Legal'), ('accounting_responsible', 'Setor Contábil'), ('negotiation_responsible', 'Negociação (Comercial)'), ('nf_responsible', 'Emissão de Notas Fiscais'), ('logistics_responsible', 'Programação e Logística')], max_length=50, verbose_name='Função')),
