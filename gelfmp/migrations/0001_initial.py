# Generated by Django 5.1.3 on 2024-12-06 18:05

import django.core.validators
import django.db.models.deletion
import gelfmp.validators.custom_validators
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latitude', models.DecimalField(blank=True, decimal_places=6, max_digits=9, null=True, validators=[gelfmp.validators.custom_validators.validate_latitude])),
                ('longitude', models.DecimalField(blank=True, decimal_places=6, max_digits=9, null=True, validators=[gelfmp.validators.custom_validators.validate_longitude])),
                ...
                ('bank_details', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='gelfmp.bankdetails', verbose_name='Detalhes Bancários')),
        ...
        migrations.AddIndex(
            model_name='supplier',
            index=models.Index(fields=['material_type'], name='gelfmp_su_materia_fd0e12_idx'),
        ),
        migrations.AddIndex(
            model_name='supplier',
            index=models.Index(fields=['state'], name='gelfmp_su_state_i_7dbac4_idx'),
        ),
        migrations.AddIndex(
            model_name='charcoalentry',
            index=models.Index(fields=['entry_date'], name='gelfmp_ch_entry_d_77632d_idx'),
        ),
    ]
