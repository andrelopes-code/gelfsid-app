# Generated by Django 5.1.3 on 2024-12-08 15:24
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True, verbose_name='Criado em')),
                ('updated_at', models.DateTimeField(auto_now=True, verbose_name='Atualizado em')),
                ('contact_type', models.CharField(choices=[('witness', 'Testemunha'), ('legal_representative', 'Representante Legal'), ('accounting_responsible', 'Responsável do Setor Contábil'), ('negotiation_responsible', 'Responsável pela Negociação'), ('nf_responsible', 'Responsável pela Emissão de Notas Fiscais')], max_length=50, verbose_name='Função')),
        ...
        migrations.CreateModel(
            ...
            options={
                'verbose_name': 'IQF Fornecedor de Carvão',
                'verbose_name_plural': 'IQFs Fornecedores de Carvão',
            },
        ),
        migrations.CreateModel(
            name='CharcoalEntry',
