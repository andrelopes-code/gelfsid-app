...
import map.validators.custom_validators
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=100, verbose_name='Nome')),
                ('state', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='map.state', verbose_name='Estado')),
            ],
            options={
                'verbose_name': 'Cidade',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('corporate_name', models.CharField(help_text='Insira nomes padronizados, como o próprio nome que consta no CNPJ para evitar inconsistência.', max_length=200, unique=True, verbose_name='Razão Social')),
                ('material_type', models.CharField(choices=[('iron_ore', 'Minério de Ferro'), ('byproducts', 'Subprodutos'), ('charcoal', 'Carvão Vegetal'), ('bauxite', 'Bauxita'), ('clay', 'Argila'), ('sand', 'Areia'), ('limestone', 'Calcário'), ('fesi_mg', 'FeSiMg'), ('ferroalloys', 'Ferroligas'), ('mixture', 'Mistura'), ('fluorite', 'Fluorita'), ('dolomite', 'Dolomita'), ('graphite', 'Grafite')], max_length=100, verbose_name='Tipo de Material')),
                ...
                ('cep', models.CharField(help_text='Informe apenas os números', max_length=8, validators=[django.core.validators.RegexValidator(message='Insira um CEP válido, digitando apenas os números.', regex='^\\d{8}$')], verbose_name='CEP')),
                ('latitude', models.DecimalField(blank=True, decimal_places=6, max_digits=9, null=True, validators=[map.validators.custom_validators.validate_latitude])),
                ('longitude', models.DecimalField(blank=True, decimal_places=6, max_digits=9, null=True, validators=[map.validators.custom_validators.validate_longitude])),
                ...
                ('bank_details', models.OneToOneField(null=True, on_delete=django.db.models.deletion.SET_NULL, to='map.bankdetails', verbose_name='Detalhes Bancários')),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='suppliers', to='map.city', verbose_name='Cidade')),
                ('state', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='suppliers', to='map.state', verbose_name='Estado')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('valid', 'Válida'), ('expired', 'Vencida'), ('renewal_valid', 'Renovação/Válida')], max_length=50, verbose_name='Status')),
                ('supplier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='documents', to='map.supplier', verbose_name='Fornecedor')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('supplier', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='contacts', to='map.supplier', verbose_name='Fornecedor')),
            ],
            options={
